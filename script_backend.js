document.addEventListener('DOMContentLoaded', function() {
    ...
    const I18N = {
        es: {
            ...
            'nav-demos': '<span class="code-keyword">const</span> <span class="code-var">demos</span>',
            ...
            'filtro-back': 'Backend',
            'demos-comment': '// Demos en vivo',
            'demos-title': 'demos_en_vivo',
            'demo-1-desc': 'Demo completa: navega el catálogo, añade al carrito, crea una cuenta o entra como admin, y paga con la tarjeta de prueba de Stripe.',
            'demo-1-t1': 'Catálogo',
            'demo-1-t2': 'Carrito',
            'demo-1-t3': 'Panel admin',
            'demo-1-t4': 'Pagos Stripe',
            'demo-2-desc': 'Acorta enlaces y sigue el número de clics. Regístrate gratis y crea tu primer enlace corto.',
            'demo-2-t1': 'Registro',
            'demo-2-t2': 'Enlaces cortos',
            'demo-2-t3': 'Contador de clics',
            'demo-2-t4': 'API REST',
        ...
        en: {
            ...
            'filtro-front': 'Frontend',
            'filtro-back': 'Backend',
            'demos-comment': '// Live demos',
            'demos-title': 'live_demos',
            'demo-1-desc': 'Full demo: browse the catalog, add to cart, create an account or sign in as admin, and pay with the Stripe test card.',
            'demo-1-t1': 'Catalog',
            'demo-1-t2': 'Cart',
            'demo-1-t3': 'Admin panel',
            'demo-1-t4': 'Stripe payments',
            'demo-2-desc': 'Shorten links and track click counts. Register for free and create your first short link.',
            'demo-2-t1': 'Sign up',
            'demo-2-t2': 'Short links',
            'demo-2-t3': 'Click counter',
            'demo-2-t4': 'REST API',
